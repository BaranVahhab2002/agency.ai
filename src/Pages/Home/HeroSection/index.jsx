...
export default function HeroSection() {
  return (
    ...
    px-4 sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden
    ...
    >
      ...
      >
        ...
        <span className="bg-gradient-to-r from-[#5d8cea] to-[#4d8cea] bg-clip-text text-transparent">
          digital
        </span>
        impact .
      </h1>
      ...
      >
        Creating meaningfull connections and turning big ideas into interactive
        digital experiences.
      </p>
      <div>
