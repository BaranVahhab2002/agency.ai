    ...
    >
      <div className="flex justify-between lg:items-center max-lg:flex-col gap-10">
        ...
        <div className="text-gray-600 dark:text-gray-400">
          ...
          <div className="felx gap-2 text-sm">
            <input
              type="email"
              name=""
              id=""
              placeholder="enter yout Email"
              className="w-full p-3 text-sm outline-none rounded-2xl
            dark:text-gray-300 dark:border-gray-500 border border-gray-300 mb-3"
            />
